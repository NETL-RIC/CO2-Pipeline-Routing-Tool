...
class PPOAgent:
    ...
    def load_model(self, model_path):
        if model_path is None:
            ...
            model_path = ('./trained_model/scripted_model.pt')
        ...
        while not terminated and not truncated:
            ...
            with torch.no_grad():
                results = self.model(
                    ...
                    observation = torch.from_numpy(np.expand_dims(observation, axis=0)),    # pass tensor for torchScript
...
class MLWrapper:
    ...
    def __init__(self, raster_dir='./cost_surfaces/10km_112nat_336reg_672loc/', model_path='./trained_model/model.pt'):
        ...
        model_path = './model_scripted.pt'  #ignoring fix_pathing for now
