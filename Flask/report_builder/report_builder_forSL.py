...
def GetIDsAndLengthOrArea(line, vg, tracts):
    """
...
class PDF(FPDF):
    def header(self):
        # Logo
        self.image(r"images/DOE_NETL_Logos.png", 10, 10, 60)
        # Arial bold 15
...
def BuildReport(shapefile, start_coordinates, end_coordinates, out_path):
    """
    ...
    vg_shp = r"inputs\vg_base.shp"
    vg_id = 'OID_'
    vg_table = r"inputs\10km_SpatialJoin_42_51_55_59_28.csv"

    tract_shp = r"inputs\tract_base.shp"
    tract_id = 'OID_'
    state_fld = "STATE_NAME"
    county_fld = "CNTY_NAME"
    tract_fld = "TRACTCE_1"

    tract_table = r"inputs\census_tract_boundaries_USA_AK.csv"

    def_table = r"inputs\report_base.csv"
    category = "Category"
    orig_table = "table"
...
output_pdf = BuildReport(line_shp, start_location, start_location, output_location)
