...
"""
This version returns an image as an observation to the agent.
"""
...
class GridWorldEnv_v4(gym.Env):
    ...
    def __init__(self, render_mode=None, shape=(10,10)):
        ...
        observation_shape = (self.window_size[1], self.window_size[0], 3)
    ...
    def step(self, action):
        ...
        if distance_to_target < self._initial_distance_target:
            euclidean_reward = 1
        elif distance_to_target == self._initial_distance_target:
            euclidean_reward = 0
        else:
            euclidean_reward = -1
    ...
    def _render_frame(self):
        ...
        # In this version we always need to return the image array regardless of render mode since the image is used
        # as an observation
        return np.transpose(
