...
"""
This version only returns the position of the agent and the position of the 
target to the agent.
"""
...
class GridWorldEnv_v3(gym.Env):
    ...
    def __init__(self, render_mode=None, shape=(10,10)):
        ...
        self.observation_space = spaces.Box(low=0, high=np.max(shape), shape=(4,), dtype=np.int64)
