...
from agent_abs_path import CustomTorchModel
...
class CustomTorchModel(TorchModelV2, nn.Module):
    ...
    def forward(self, observation, state, seq_lens):
        ...
        # observation = input_dict['obs'] # observation must be passed as tensor for torchscript
...
model_scripted.save('./model_scripted_local.pt')